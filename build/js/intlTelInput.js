        ...
        _getCountryData: function(countryCode, ignoreOnlyCountriesOption, allowFail) {
            ...
            if (allowFail) {
                ...
                for (i = 0; i < countryList.length; i++) {
                    if (countryList[i].iso2 == this.options.preferredCountries[0]) {
                        return countryList[i];
                    }
                }
            }
